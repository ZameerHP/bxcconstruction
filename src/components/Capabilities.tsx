...
export default function Capabilities() {
  ...
  return (
    <section id="capabilities" className="bg-bxc-bg py-16 sm:py-24 md:py-32 w-full border-t border-bxc-border-light/60">
      <div className="max-w-7xl mx-auto px-4 xs:px-6 md:px-8">
        <ScrollReveal>
          <div className="mb-10 sm:mb-14 max-w-2xl">
            ...
            <h2 className="text-section font-semibold text-bxc-text mb-3 sm:mb-4 tracking-tight">
              Full-Spectrum Construction Capability
            </h2>
            <p className="text-sm xs:text-base md:text-lg text-bxc-text/70 font-normal leading-relaxed">
          ...
          {capabilities.map((item, idx) => (
            <ScrollReveal key={idx} delay={idx * 0.15}>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 transform transition-transform duration-300 group-hover:-translate-y-1">
                  <span className="text-[10px] sm:text-[11px] uppercase font-bold tracking-widest text-bxc-accent block mb-1.5 sm:mb-2">
                    {item.phase}
                  </span>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-bxc-bg mb-1.5 sm:mb-2 leading-snug">
                    {item.title}
                  </h3>
