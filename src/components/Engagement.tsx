...
export default function Engagement() {
  return (
    <section id="engagement" className="bg-bxc-bg py-16 sm:py-24 md:py-32 w-full border-t border-bxc-border-light/60">
      <div className="max-w-7xl mx-auto px-4 xs:px-6 md:px-8">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          <StaggerItem>
            <div className="bg-white rounded-card-lg p-6 sm:p-8 md:p-9 border border-bxc-border-light text-center flex flex-col h-full hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-xs md:text-sm text-bxc-text/70 leading-relaxed mb-6 sm:mb-8 flex-grow">
              ...
              <MagneticButton
                href="#contact"
                variant="outline"
                className="w-full py-3 text-xs uppercase tracking-wider font-semibold min-h-[44px] flex items-center justify-center"
              >
          ...
          <StaggerItem>
            <div className="bg-bxc-dark text-bxc-bg border-bxc-accent border-2 rounded-card-lg p-6 sm:p-8 md:p-9 text-center flex flex-col h-full md:scale-[1.03] scale-100 shadow-2xl shadow-bxc-accent/20 relative hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-xs md:text-sm text-bxc-bg/75 leading-relaxed mb-6 sm:mb-8 flex-grow">
              ...
              <MagneticButton
                href="#contact"
                variant="primary"
                className="w-full py-3.5 text-xs uppercase tracking-wider font-bold shadow-lg min-h-[44px] flex items-center justify-center"
              >
